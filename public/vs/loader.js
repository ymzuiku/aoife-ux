...
!(function (e) {
  ...
  (function (e) {
    ...
    var r = (function () {
      function r() {}
      return (
        (r.validateConfigurationOptions = function (r) {
          if (
            ...
            void 0 === r.catchError && (r.catchError = !1),
            void 0 === r.recordStats && (r.recordStats = !1),
            ...
            r.baseUrl.length > 0 &&
              (e.Utilities.endsWith(r.baseUrl, "/") || (r.baseUrl += "/")),
            "string" != typeof r.cspNonce && (r.cspNonce = ""),
            void 0 === r.preferScriptTags && (r.preferScriptTags = !1),
            Array.isArray(r.nodeModules) || (r.nodeModules = []),
            r.nodeCachedData &&
              "object" == typeof r.nodeCachedData &&
              ("string" != typeof r.nodeCachedData.seed &&
                (r.nodeCachedData.seed = "seed"),
              ("number" != typeof r.nodeCachedData.writeDelay ||
                r.nodeCachedData.writeDelay < 0) &&
                (r.nodeCachedData.writeDelay = 7e3),
              !r.nodeCachedData.path ||
                "string" != typeof r.nodeCachedData.path))
          ) {
            var n = t(
        ...
        (r.mergeConfigurationOptions = function (t, n) {
          ...
          return (
            e.Utilities.forEachProperty(t, function (t, r) {
              "ignoreDuplicateModules" === t &&
              void 0 !== o.ignoreDuplicateModules
                ? (o.ignoreDuplicateModules = o.ignoreDuplicateModules.concat(
                    r
                  ))
            ...
            r.validateConfigurationOptions(o)
          );
        }),
        r
      );
    ...
    var n = (function () {
      function t(e, t) {
        if (
          ((this._env = e),
          (this.options = r.mergeConfigurationOptions(t)),
      ...
      return (
        ...
        (t.prototype.cloneAndMerge = function (e) {
          return new t(this._env, r.mergeConfigurationOptions(e, this.options));
        }),
  ...
  (function (e) {
    var t = (function () {
        ...
        return (
          (e.prototype.load = function (e, t, i, s) {
            ...
            if (!this._scriptLoader)
              if (this._env.isWebWorker) this._scriptLoader = new n();
              else if (this._env.isElectronRenderer) {
                var d = e.getConfig().getOptionsLiteral().preferScriptTags;
                this._scriptLoader = d ? new r() : new o(this._env);
              } else
                this._env.isNode
                  ? (this._scriptLoader = new o(this._env))
                  : (this._scriptLoader = new r());
            var u = { callback: i, errorback: s };
      ...
      r = (function () {
        function t() {}
        return (
          (t.prototype.attachListeners = function (e, t, r) {
            var n = function () {
          ...
          (t.prototype.load = function (t, r, n, o) {
            if (/^node\|/.test(r)) {
              var i =
                  t.getConfig().getOptionsLiteral().nodeRequire ||
                  e.global.nodeRequire,
                s = r.split("|"),
                a = null;
              try {
                a = i(s[1]);
              ...
              d.setAttribute("async", "async"),
                ...
                this.attachListeners(d, n, o),
                d.setAttribute("src", r);
              var u = t.getConfig().getOptionsLiteral().cspNonce;
        ...
        return (
            ...
            if (r && !this._didPatchNodeRequire) {
              ...
              o.prototype._compile = function (e, i) {
                var s,
                  ...
                  l = { filename: i };
                try {
                  var c = n._fs.readFileSync(u);
                  (s = c.slice(0, 16)),
                    (l.cachedData = c.slice(16)),
                    d.record(60, u);
                } catch (e) {
                  d.record(61, u);
                }
                var h = new n._vm.Script(a, l),
                  ...
                  v = f.apply(this.exports, g);
                return (
                  n._handleCachedData(h, a, u, !l.cachedData, t),
                  n._verifyCachedData(h, a, u, s, t),
                  v
                );
              };
            }
          ...
          (t.prototype.load = function (r, n, o, i) {
            ...
            if (/^node\|/.test(n)) {
              ...
              var f = this._path.normalize(n),
                p = this._getElectronRendererScriptPathOrUri(f),
                _ = Boolean(a.nodeCachedData),
                g = _ ? this._getCachedDataPath(a.nodeCachedData, n) : void 0;
              this._readSourceAndCachedData(f, g, l, function (e, n, a, d) {
                if (e) i(e);
                else {
                  var l;
                  (l =
                    n.charCodeAt(0) === t._BOM
                      ? t._PREFIX + n.substring(1) + t._SUFFIX
                      : t._PREFIX + n + t._SUFFIX),
                    (l = u(l, f));
                  var c = { filename: p, cachedData: a },
                    h = s._createAndEvalScript(r, l, c, o, i);
                  s._handleCachedData(h, l, g, _ && !a, r),
                    s._verifyCachedData(h, l, g, d, r);
                }
              });
            }
          }),
          (t.prototype._createAndEvalScript = function (t, r, n, o, i) {
            ...
            var a = new this._vm.Script(r, n),
              d = a.runInThisContext(n),
              u = t.getGlobalAMDDefineFunc(),
              l = !1,
              c = function () {
                return (l = !0), u.apply(null, arguments);
              };
            return (
              (c.amd = u.amd),
              d.call(
              ...
              l
                ...
                : i(
                    new Error(
                      "Didn't receive define call in " + n.filename + "!"
                    )
                  ),
              a
            );
          ...
          (t.prototype._handleCachedData = function (e, t, r, n, o) {
            ...
            e.cachedDataRejected
              ? this._fs.unlink(r, function (n) {
                  o.getRecorder().record(62, r),
                    i._createAndWriteCachedData(e, t, r, o),
                    n && o.getConfig().onError(n);
                })
              : n && this._createAndWriteCachedData(e, t, r, o);
          }),
                ...
                setTimeout(function () {
                  ...
                  0 === i.length ||
                    ...
                    (i.length < s
                      ? u()
                      : ((s = i.length),
                        o._fs.writeFile(r, Buffer.concat([d, i]), function (e) {
                          e && n.getConfig().onError(e),
                            n.getRecorder().record(63, r),
                            u();
                        })));
                }, i * Math.pow(4, a++));
              };
          ...
          (t.prototype._readSourceAndCachedData = function (e, t, r, n) {
            if (t) {
              var o = void 0,
                ...
                a = 2,
                d = function (e) {
                  e ? n(e) : 0 == --a && n(void 0, o, i, s);
                };
              this._fs.readFile(e, { encoding: "utf8" }, function (e, t) {
                (o = t), d(e);
              }),
                this._fs.readFile(t, function (e, n) {
                  !e && n && n.length > 0
                    ? ((s = n.slice(0, 16)), (i = n.slice(16)), r.record(60, t))
                    : r.record(61, t),
                    d();
                });
    ...
    var s = (function () {
      ...
      return (
        ...
        (s._findRelevantLocationInStack = function (e, t) {
          for (
            ...
            if (s) {
              ...
              if ((a = r((a = a.substr(l)))) === n) {
                var c = { line: parseInt(d, 10), col: parseInt(u, 10) };
                return (
                  1 === c.line &&
          ...
          for (
            ...
            if (o) {
              ...
              e[t++] = {
                ...
                path: i,
                defineLocation:
                  i && a ? s._findRelevantLocationInStack(i, a) : null,
                dependencies: d,
                shim: null,
                exports: o.exports,
              };
        ...
        (s.prototype.enqueueDefineAnonymousModule = function (e, t) {
          if (null !== this._currentAnnonymousDefineCall) return;
          // throw new Error(
        ...
        (s.prototype.defineModule = function (e, n, o, i, s, a) {
          ...
          if (this._modules2[u])
            ...
            var l = new r(u, e, this._normalizeDependencies(n, a), o, i, a);
            (this._modules2[u] = l),
              this._config.isBuild() &&
                ((this._buildInfoDefineStack[u] = s),
                (this._buildInfoDependencies[u] = (l.dependencies || []).map(
                  function (e) {
        ...
        (s.prototype._createLoadError = function (t, r) {
          var n = this,
            ...
            i = (this._inverseDependencies2[t] || []).map(function (e) {
        ...
        (s.prototype._onLoadError = function (e, t) {
          ...
          for (d.push(e), o[e] = !0; d.length > 0; ) {
            var u = d.shift(),
              l = this._modules2[u];
            l && (a = l.onDependencyError(n) || a);
            var c = this._inverseDependencies2[u];
            if (c)
    ...
    function s() {
      if (void 0 !== e.global.require || "undefined" != typeof require) {
        ...
        if ("function" == typeof o && "function" == typeof o.resolve) {
          ...
          (e.global.nodeRequire = s),
            (i.nodeRequire = s),
            (i.__$__nodeRequire = s);
        }
      }
      t.isNode && !t.isElectronRenderer
        ? ((module.exports = i), (require = i))
        : (t.isElectronRenderer || (e.global.define = n),
          (e.global.require = i));
    }
    (i.config = o),
      ...
      ("function" == typeof e.global.define && e.global.define.amd) ||
        ...
        void 0 !== e.global.require &&
          ...
          i.config(e.global.require),
        ((define = function () {
          return n.apply(null, arguments);
        }).amd = n.amd),
        "undefined" == typeof doNotInitLoader && s());
  })(AMDLoader || (AMDLoader = {}));
